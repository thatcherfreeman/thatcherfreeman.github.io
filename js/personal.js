...
(function ($) {
    ...
    function pageFunctions() {
        ...
        $(".gallery").each(function () {
            ...
            var numChildren = $this.children("img").length;
            ...
            $this.imagesLoaded(function () {
                // If it's a single column gallery and has more than one entry
                if (numChildren > parseInt(galleryCols, 10)) {
    ...
    $(document).on("submit", "#contact-form", function (e) {
        ...
        $(".contact-form__item--error").removeClass(
